  ...
  return (
    <Layout>
      <motion.div
        ...
        className=" px-4 py-8 bg-white m-4 rounded-lg shadow-md p-6 border border-gray-100"
      >
        {/* Header Section */}
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            <div className="p-4 bg-gradient-to-r from-[var(--primary-400)] to-[var(--primary-500)] border-b border-gray-100">
              <div className="flex items-center gap-3">
                ...
                <h3 className="font-semibold text-white">Job Fair Events</h3>
              </div>
            </div>
            ...
            <div className="p-4">
              {loadingEvents ? (
                ...
                <div className="text-center py-8 text-gray-500">
                  ...
                  <p className="font-medium">No Job Fair Events Available</p>
                  <p className="text-sm">
                ...
                {company?.name ? (
                          ...
                          {loadingProfiles ? (
                            ...
                            >
                              ...
                              <p className="text-gray-500">
                                This company doesn't have any open positions at
                                the moment.
                              </p>
                            </motion.div>
                          )}
                  ...
                  >
                    <div>
                      ...
                      <p className="text-gray-500 max-w-md">
                        Choose a company from the list to view their details and
                        available positions.
                      </p>
                    </div>
                  </motion.div>
