...
const InterviewRequestsManager = () => {
  ...
  const fetchParticipationAndJobProfiles = async () => {
    try {
      ...
      if (!participation)
        throw new Error('Participation not found for this company');

      setParticipationId(participation.id);

      const jobProfilesRes = await api.get(
        `/job-fairs/${jobFairId}/participations/${participation.id}/job-profiles`
      );
  ...
  const reviewInterviewRequest = async (requestId, status) => {
    try {
      ...
      await api.put(`/job-fairs/interview-requests/${requestId}/review`, {
        status,
      });
      if (selectedProfile && participationId) {
        fetchInterviewRequests(participationId, selectedProfile.id);
              ...
              <div className="px-6 py-6 bg-gradient-to-br from-slate-900 via-[#203947] to-[#901b20] text-white relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-white/90 mt-2 font-medium">
                    {jobProfiles.length} active positions
                  </p>
                </div>
              </div>
                      ...
                      <div className="flex flex-col items-center">
                        <ArrowUpRight
                          className={`h-5 w-5 text-gray-400 transition-all duration-300 ${
                            selectedProfile?.id === profile.id
                              ? 'text-[#901b20] scale-110'
                              : 'group-hover:text-[#901b20]'
                          }`}
                        />
                      </div>
                    </div>
          ...
          <div className="xl:col-span-3">
            {selectedProfile ? (
                  ...
                  <div className="px-8 py-6 bg-gradient-to-r from-[#203947] via-[#ad565a] to-[#203947] text-white relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-white/90 font-medium">
                        {selectedProfile.participation?.company?.name} •{' '}
              ...
              <div className="bg-white/70 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-20 text-center">
                ...
                <h3 className="text-3xl font-bold text-[#203947] mb-4">
                  Select a Job Profile
                </h3>
                <p className="text-gray-600 text-xl max-w-lg mx-auto leading-relaxed">
                  Choose a job profile from the sidebar to view and manage
                  interview requests.
                </p>
              </div>
            )}
            ...
            <div className="px-6 py-6 bg-gradient-to-br from-slate-900 via-[#203947] to-[#901b20] text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-3xl font-bold text-white mb-2">
                  {selectedUserRequest.user.first_name}{' '}
                  {selectedUserRequest.user.last_name}
                </h2>
                ...
                <div className="space-y-4">
                  <div className="group hover:bg-[#ebebeb]/50 p-4 rounded-2xl transition-all duration-300 hover:shadow-md">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <span className="text-[#203947] font-semibold text-sm">
                          Email
                        </span>
                        <p className="text-[#203947] font-medium">
                          {selectedUserRequest.user.email}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="group hover:bg-[#ebebeb]/50 p-4 rounded-2xl transition-all duration-300 hover:shadow-md">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-[#203947] font-medium">
                          {selectedUserRequest.user.phone || 'N/A'}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="group hover:bg-[#ebebeb]/50 p-4 rounded-2xl transition-all duration-300 hover:shadow-md">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-[#203947] font-medium">
                          {selectedUserRequest.user.intake_year}
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="group hover:bg-[#ebebeb]/50 p-4 rounded-2xl transition-all duration-300 hover:shadow-md">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-[#203947] font-medium">
                          {selectedUserRequest.user.graduation_year}
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      <p className="text-[#203947] font-medium">
                        {selectedUserRequest.user.linkedin_url ? (
                          <a
                            href={selectedUserRequest.user.linkedin_url}
                            target="_blank"
                            className="text-[#901b20] hover:text-[#ad565a] underline transition-colors duration-300"
                          >
                            Profile
                          </a>
                        ) : (
                    ...
                    <div>
                      ...
                      <p className="text-[#203947] font-medium">
                        {selectedUserRequest.user.github_url ? (
                          <a
                            href={selectedUserRequest.user.github_url}
                            target="_blank"
                            className="text-[#901b20] hover:text-[#ad565a] underline transition-colors duration-300"
                          >
                            Repo
                    ...
                    <div>
                      ...
                      <p className="text-[#203947] font-medium">
                        {selectedUserRequest.user.portfolio_url ? (
                          <a
                            href={selectedUserRequest.user.portfolio_url}
                            target="_blank"
                            className="text-[#901b20] hover:text-[#ad565a] underline transition-colors duration-300"
                          >
                            Website
                    ...
                    <div>
                      ...
                      <p className="text-[#203947] font-medium">
                        {selectedUserRequest.user.cv_path ? (
                          <a
                            href={selectedUserRequest.user.cv_path}
                            target="_blank"
                            className="text-[#901b20] hover:text-[#ad565a] underline transition-colors duration-300"
                          >
                            Download CV
