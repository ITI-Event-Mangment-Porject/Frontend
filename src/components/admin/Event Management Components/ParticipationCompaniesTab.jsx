        ...
        <div className="text-center py-12">
          <div className="max-w-md mx-auto">
            ...
            <p className="mt-1 text-gray-500">
              {searchTerm ? 'Try adjusting your search criteria.' : 'Companies will appear here once they register for the event.'}
            </p>
          </div>
        </div>
      ) : (
              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {currentCompanies.map((participation, index) => {
                    const company = participation.company;
                    return (
                      <tr key={participation.id} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getSizeColorClasses(company.size)}`}>
                            {company.size}
                          </span>
                        </td>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          <div className="space-y-1">
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              <a href={`tel:${company.contact_phone}`} className="hover:text-(--primary-500)">
              ...
              <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                <div>
                  <p className="text-sm text-gray-700">
                    ...
                    <span className="font-medium">{Math.min(indexOfLastItem, filteredAndSortedCompanies.length)}</span> of{' '}
                    <span className="font-medium">{filteredAndSortedCompanies.length}</span> results
                  </p>
                </div>
                <div>
