    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
      <div className="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 relative">
        ...
        <div className="absolute top-2 right-2 flex gap-2">
          <span
            className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(participation.status)}`}
          >
            {participation.status.charAt(0).toUpperCase() +
              participation.status.slice(1)}
          </span>
          <span
            className={`px-2 py-1 rounded-full text-xs font-medium ${getSizeColor(company.size)}`}
          >
      ...
      <div className="p-4">
        <div className="space-y-2 mb-3 text-sm text-gray-600">
          ...
          <div className="flex items-center">
            ...
            Applied: {formatDate(participation.submitted_at)}
          </div>
